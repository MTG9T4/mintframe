...
- A Bold letter coin-image style makes a clean, flat-color lettermark from the coin name or up to two custom letters. Background and letter colors are editable; the 72px avatar preview and all coin-image exports show the same result. MintFrame's generated project coin image is at [assets/mintframe-coin.png](assets/mintframe-coin.png).
