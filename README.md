...
- A mobile-friendly Pump handoff saves the coin image and banner separately, offers one-tap copying for each launch field, and opens Pump's official create form. No cross-site prefill flow is documented in Pump's public creation guide, so the creator selects files and confirms the launch there.
